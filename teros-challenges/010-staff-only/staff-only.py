...
if __name__ == "__main__":
	...
	initDb()
	# Muutettu default tyhjästä tähän, jotta kontin app jakautuu Hostille käytettäväksi
	app.run(host="0.0.0.0", port=5000) # host="0.0.0.0" to serve non-localhost, e.g. from vagrant; debug=True for debug
